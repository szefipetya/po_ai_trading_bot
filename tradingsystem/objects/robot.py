...
class PyRobot():
    def __init__(self, client_id:str, redurect_uri: str, credentials_path: str =None, trading_account: str=None)->None:
        self.trading_account: str =trading_account
        self.client_id: str = client_id
        self.redurect_uri: str = redurect_uri
    ...
    def _create_session(self)->TDClient:
        td_client = TDClient(
            ...
            redirect_uri=self.redurect_uri,
