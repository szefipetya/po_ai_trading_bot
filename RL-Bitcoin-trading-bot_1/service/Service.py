...
class Service:
    def run(self):
        ...
        continue_train_multiprocessing(CustomEnv, agent, train_df, train_df_nomalized, train_state, num_worker = 10, training_batch_size=500, visualize=False, EPISODES=600000,smoothing=10)
